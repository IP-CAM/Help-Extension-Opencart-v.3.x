...
class ControllerStartupSeoUrl extends Controller {
		...
		if (isset($this->request->get['_route_'])) {
			...
			foreach ($parts as $part) {
				...
				if ($query->num_rows) {
                    ...
                    if ($url[0] == 'help_category_id') {
                        $this->request->get['help_category_id'] = $url[1];
                    }

					if ($query->row['query'] && $url[0] != 'information_id' && $url[0] != 'help_category_id' && $url[0] != 'manufacturer_id' && $url[0] != 'category_id' && $url[0] != 'product_id') {
			...
			if (!isset($this->request->get['route'])) {
				if (isset($this->request->get['product_id'])) {
					...
					$this->request->get['route'] = 'extension/module/help_nik/faq';
				}
			}
		// Redirect 301   
			...
			} elseif ($this->request->get['route'] == 'extension/module/help_nik/faq' && isset($this->request->get['help_category_id'])) {
				$route = 'help_category_id=' . (int)$this->request->get['help_category_id'];
	...
	public function rewrite($link) {
		...
		foreach ($data as $key => $value) {
			if (isset($data['route'])) {
				if (($data['route'] == 'product/product' && $key == 'product_id') || (($data['route'] == 'product/manufacturer/info' || $data['route'] == 'product/product') && $key == 'manufacturer_id') || ($data['route'] == 'information/information' && $key == 'information_id') || ($data['route'] == 'extension/module/help_nik/faq' && $key == 'help_category_id')) {
